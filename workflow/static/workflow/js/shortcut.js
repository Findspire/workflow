...
function compute_total_items_state() {
    window.gl_not_solved = $("div.categories_table_workflow td.state-item-None").length;
    window.gl_success = $("div.categories_table_workflow td.state-item-OK").length;
    window.gl_failed = $("div.categories_table_workflow td.state-item-KO").length;
    window.gl_total = window.gl_success + window.gl_failed + window.gl_not_solved;
    update_statistics_progressbar();
    $("#progress_bar").html(progressbar);
    window.gl_total = window.gl_taken + window.gl_untaken;
...
function compute_taken_untaken_items() {
    ...
    window.gl_taken = taken_item_cel.length;
    window.gl_untaken = untaken_item_cel.length;
    update_statistics_filters();
}
...
function  _update_item_shortcut(data, link, el) {
	...
	ok_shortcut += " title='Click to validate'><img src='/static/workflow/img/validation_OK_disabled.png'/></a>";
	...
	ko_shortcut += "' title='Click to mark as broken'><img src='/static/workflow/img/validation_KO_disabled.png'/></a>";
	...
	if ($(el).hasClass("shortcut-disabled-KO")) {
		...
		ko_shortcut += "<img src='/static/workflow/img/validation_KO.png'/></a>";
		...
		ok_shortcut += "<img src='/static/workflow/img/validation_OK.png'/></a>";
...
function _update_item_add_owner(data, link, el) {
    ...
    content += " <a href='" + href + "' title='Untake item'><img src='/static/workflow/img/untake.png' /></a>";
